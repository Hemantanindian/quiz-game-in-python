...
lblinfo = Label(root, font=( 'aria', 30, 'bold' ), text="You give only one or less correct answer.",fg="steel blue", bg="bisque", bd=10, anchor='w')
lblinfo.grid(row=0, column=0)
lblinfo = Label(root, font=( 'aria', 30, 'bold' ), text="You have very bad general knowledge",fg="steel blue", bg="bisque", bd=10, anchor='w')
